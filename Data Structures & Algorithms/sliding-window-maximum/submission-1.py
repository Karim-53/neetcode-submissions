class Solution:
    def maxSlidingWindow(self, nums: List[int], k: int) -> List[int]:
        ...
        for i in range(k, len(nums)):
            ...
            # Optimization: Skip tree traversal for max if the outgoing element wasn't the max
            if out_val != current_max:
                current_max = max(current_max, in_val)
            else:
                current_max = bst.get_max()
